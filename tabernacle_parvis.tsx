...
const TabernacleParvis = () => {
  ...
  const elements = {
    autel: {
      ...
      description: "Fait de bois d'acacia recouvert d'airain (bronze). Dimensions: 5 coudées × 5 coudées × 3 coudées de haut. C'est ici que les sacrifices d'animaux étaient offerts, symbolisant l'expiation par le sang.",
      reference: "Exode 27:1-8",
      symbolism: "Préfigure le sacrifice de Christ à la croix - le jugement de Dieu sur le péché."
    },
    cuve: {
      title: "Cuve d'Airain (Bassin de Bronze)",
      description: "Faite de bronze poli provenant des miroirs des femmes d'Israël. Contenait de l'eau pour les ablutions des sacrificateurs avant d'entrer dans le Lieu Saint.",
      reference: "Exode 30:17-21",
      symbolism: "Représente la purification par la Parole de Dieu - la sanctification du croyant."
    },
    tente: {
      title: "Le Tabernacle (Tente d'Assignation)",
      description: "Structure de 30 coudées × 10 coudées × 10 coudées, divisée en deux parties : le Lieu Saint et le Lieu Très Saint (Saint des Saints), séparés par un voile.",
      reference: "Exode 26",
      symbolism: "Demeure de Dieu au milieu de son peuple - préfigure Christ 'tabernacling' parmi nous (Jean 1:14)."
    },
    parvis: {
      title: "Le Parvis",
      description: "Enceinte de 100 coudées × 50 coudées, entourée de toiles de lin blanc suspendues à des colonnes d'airain. Seule entrée : à l'Est.",
      reference: "Exode 27:9-19",
      symbolism: "La sainteté de Dieu - séparation d'avec le monde. L'entrée unique à l'Est préfigure Christ, 'la Porte' (Jean 10:9)."
    },
    entree: {
      title: "La Porte du Parvis",
      description: "Rideau de 20 coudées de large, tissé de fils bleu, pourpre, cramoisi et de fin lin retors. Unique accès au Tabernacle.",
    ...
    <div className="w-full h-screen bg-gradient-to-b from-amber-50 to-stone-100 p-4 overflow-auto">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-center text-amber-900 mb-2">
          Le Tabernacle du Désert - Vue du Parvis
        </h1>
        ...
        <div className="relative bg-gradient-to-b from-yellow-100 to-amber-100 rounded-lg shadow-2xl p-8 mb-6 border-4 border-amber-800">
          ...
          {/* Le Parvis (enceinte extérieure) */}
          <svg viewBox="0 0 800 500" className="w-full h-auto">
            {/* Fond sable du désert */}
            ...
            <g onClick={() => setSelectedElement(elements.tente)} className="cursor-pointer">
              ...
              {/* Toiles extérieures (peaux de béliers teintes en rouge) */}
              <path 
              ...
              {/* Couverture supérieure (peaux de dauphins/phoques) */}
              <path 
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-amber-800 font-semibold mb-2">
                  📖 Référence : {selectedElement.reference}
                </p>
        ...
        {!selectedElement && (
          <div className="bg-amber-100 rounded-lg p-4 border border-amber-300">
            <p className="text-center text-amber-900">
              <strong>Cliquez sur les éléments du Tabernacle</strong> pour découvrir leur signification biblique et typologique.
            </p>
          </div>
        )}
        ...
        <div className="mt-6 bg-stone-100 rounded-lg p-4 text-sm text-stone-700">
          ...
          <ul className="space-y-1 list-disc list-inside">
            <li><strong>Orientation :</strong> L'entrée est toujours à l'EST (symbolisant Christ, "la Lumière du Monde")</li>
            <li><strong>Progression :</strong> De l'extérieur vers l'intérieur = chemin du croyant vers la présence de Dieu</li>
            <li><strong>Matériaux :</strong> Airain (jugement), Argent (rédemption), Or (gloire divine)</li>
            <li><strong>Coudée :</strong> Environ 45-50 cm (mesure biblique standard)</li>
          </ul>
        </div>
      </div>
    </div>
